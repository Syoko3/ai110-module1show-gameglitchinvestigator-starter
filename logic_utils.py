#FIX: Refactored game logic into logic_utils.py using Copilot Agent mode to fix the bugs on the number range and number of attempts based on selected modes.
